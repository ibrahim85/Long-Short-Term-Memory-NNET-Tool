...
import machine_learning_project_refined
import sys
import argparse
...
if __name__ == "__main__":
    ...
    if not args.infile or not args.outfile:
        ...
        machine_learning_project_refined.set_configuration(input_filename=given["input_filename"],
            output_filename=given["output_filename"], n_layers=given["n_layers"], n_dropout_layers=given["n_dropout_layers"],
